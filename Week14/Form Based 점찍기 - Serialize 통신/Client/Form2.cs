...
namespace _20143184_하지훈
{
    public partial class Form2 : Form
    {
        ...
        public Color DialogpColor { get; set; }
        ...
        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            try
            {
                if (textBox1.Text == "" || int.Parse(textBox1.Text) < 0 || int.Parse(textBox1.Text) > 256)
                {
                    MessageBox.Show("올바른 숫자를 입력해주세요.");
                }
                else
        ...
        private void textBox2_TextChanged(object sender, EventArgs e)
        {
            try
            {
                if (textBox2.Text == "" || int.Parse(textBox2.Text) < 0 || int.Parse(textBox2.Text) > 256)
                {
                    MessageBox.Show("올바른 숫자를 입력해주세요.");
                }
                else
        ...
        private void textBox3_TextChanged(object sender, EventArgs e)
        {
            try
            {
                if (textBox3.Text == "" || int.Parse(textBox3.Text) < 0 || int.Parse(textBox3.Text) > 256)
                {
                    MessageBox.Show("올바른 숫자를 입력해주세요.");
                }
                else
